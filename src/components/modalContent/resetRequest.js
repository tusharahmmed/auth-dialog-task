...
import {resetRequestSchema} from "@/schemas/resetRequest";
...
const ResetRequest = () => {
  ...
  const onSubmit = (data) => {
    ...
    dispatch(setRender("resetVerify"));
  };
  const defaultVal = {
          ...
          <div>
            <Form
              ...
              <div className="flex items-center justify-center gap-4">
                ...
                <Button
                  type="submit"
                  className="block bg-theme-blue text-theme-white font-roboto leading-[124.386%] px-[40px] py-4 h-auto rounded-[90px] hover:bg-theme-blue">
                  SUBMIT
                </Button>
              </div>
            </Form>
