...
export default function DialogModal({render, children}) {
  ...
  return (
    <Dialog open={open}>
      ...
      <DialogContent
        setOpen={setOpen}
        className="h-[580px] lg:h-[450px] lg:max-w-[767px] xl:max-w-[1080px]  2xl:max-w-[1080px] rounded-[25px] bg-theme-white-light border-4 border-theme-gray shadow-[0px 0px 4px 0px rgba(129, 129, 129, 0.25)] p-0 flex-col">
